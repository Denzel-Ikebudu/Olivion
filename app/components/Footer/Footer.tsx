...
export default function Footer() {
  return (
    <>
      <div className="px-[8%] lg:px-[12%] pb-20 mb-0 footer relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pb-15">
          <div className="footer-content">
            <Link
              href="/"
              className="text-2xl lg:text-5xl md:text-4xl font-bold Audiowide text-white"
            >
            ...
            <p className="text-gray-300 GolosText">5609 Sprague Ave, Spokane Valley, WA 99212, USA</p>
          </div>
          ...
          <div className="footer-content py-3">
            <ul className="footer-links flex flex-col">
                ...
                <Link href="/" className="text-gray-300 GolosText mb-1 text-xl transition-all duration-300 hover:text-(--prim) hover:ml-2">Affiliate Programs</Link>
          ...
          <div className="footer-content py-3 flex-col">
            <h2 className="text-3xl text-(--prim) underline CalSans mb-3">+(084) 456-0789</h2>
            <h2 className="text-2xl text-gray-300 GolosText">Support@olivion.com</h2>
        ...
        <div className="footer-bottom flex justify-center items-center py-8 border-t border-gray-500">
            <p className="text-gray-300 text-lg">Copyright 2025. All rights reserved By
                <Link href="#" className="transition-all duration-300 font-semibold text-white text-xl hover:text-(--prim)"> DenzEL</Link>
            </p>
        </div>
      </div>
    </>
